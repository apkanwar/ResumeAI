  ...
  return (
    <>
      ...
      {showDashboard ? (
              ...
              <aside className="h-fit rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm">
                <div className="mb-4 flex items-center gap-3 rounded-xl border border-top-orange bg-top-orange/20 p-3">
                  ...
                  <div className="flex flex-col">
                    <div
                      className="overflow-hidden min-w-0 text-sm font-semibold text-slate-900"
                      style={{
                        display: "-webkit-box",
                        WebkitLineClamp: 2,
                    ...
                    <div className="mt-1 text-xs text-slate-500 block md:hidden">
                      Tokens: <span className="text-sm px-1">{tokenLabel}</span>
                    </div>
                  </div>
                </div>
        ...
        <div className="pt-20 px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-9rem)] flex items-center justify-center">
          <div className="max-w-md rounded-2xl border border-slate-200 bg-white/80 p-8 text-center shadow-sm">
            ...
            <p className="mt-4 text-xs text-slate-600">
              ...
              <Link href="/privacy" className="font-semibold text-slate-700 hover:text-top-orange">
                Privacy Policy
              </Link>{" "}
              and{" "}
              <Link href="/tos" className="hover:text-top-orange font-semibold text-slate-700">
                Terms of Service
              </Link>
              .
            </p>
