                    ...
                    {router.pathname === '/uploads' ? (
                        <>
                            <div className="flex items-center gap-4 bg-artic-blue rounded-full p-2 font-headings font-medium">
                                <Link href={'/'} className="p-1 pt-0.5 text-white rounded-full hover:bg-gray-300 font-main">
                                    <Home color="warning" />
                                </Link>
                            </div>
                            <div className="flex items-center gap-4 bg-artic-blue rounded-full p-2 font-headings font-medium">
                        ...
                        <>
                            ...
                            <div className="flex items-center gap-4 bg-artic-blue rounded-full p-2 font-headings font-medium">
                                <Link href={'/uploads'} className="p-1 pt-0.5 text-white rounded-full hover:bg-gray-300 font-main">
